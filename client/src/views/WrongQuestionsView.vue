...
<template>
    <div class="wrong-page">
        ...
        <n-spin :show="loading">
            <n-empty v-if="!loading && !list.length" description="还没有错题，继续保持" class="wrong-empty" />
            <n-card v-for="w in list" :key="w.id" class="wrong-card" size="small">
                ...
                <div class="wrong-actions">
                    ...
                    <n-popconfirm @positive-click="removeWrong(w.id)" positive-text="确定" negative-text="取消">
                        <template #trigger>
